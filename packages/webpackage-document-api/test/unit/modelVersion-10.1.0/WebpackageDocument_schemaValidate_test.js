...
describe('WebpackageDocument Schema Validation (modelVersion 10.1.0)', function () {
  ...
  describe('validate', function () {
    ...
    describe('validation for manifest.webpackage', function () {
      ...
      beforeEach(function () {
        var pathName = path.resolve(__dirname, '../../resource/modelVersion-10.1.0/manifest.webpackage');
